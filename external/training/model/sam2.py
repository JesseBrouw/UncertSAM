...
class SAM2Train(SAM2Base):
    ...
    def track_step(
        ...
        current_out["multistep_pred_ious_logvar"] = [ious_logvar]
    ...
    def _iter_correct_pt_sampling(
        ...
        all_pred_ious = [ious]
        all_pred_ious_logvar = [ious_logvar]
        ...
        for _ in range(self.num_correction_pt_per_frame):
            ...
            all_pred_ious_logvar.append(ious_logvar)
        ...
        current_out["multistep_pred_ious_logvar"] = all_pred_ious_logvar
